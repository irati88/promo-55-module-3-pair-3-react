...
const Form = (props) => {
  ...
  const handleLegalTerms = (ev) => {
    ...
    const isValidForm = () => {
      // El formulario solo es válido cuando los inputs de tipo texto no estén vacíos, 
      // cuando se haya marcado un tipo de pago y cuando los términos legales sean true
      // También podríamos comprobar que el email tiene el formato correcto, pero no queremos 
      // complicar este ejemplo
      if (
        name !== "" &&
        email !== "" &&
        paymentType !== "" &&
